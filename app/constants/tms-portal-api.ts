...
/** Rescates ya subidos (correct_upload y/o manual_upload). Filtros: correct_upload, manual_upload, folio. */
export const TMS_RESCUE_COMPLETED_LIST_PATH =
  '/api/invoicing/client_portal/tms/rescues/paginated/';
export const TMS_RESCUE_COMPLETED_LIST_QUERY_KEY = [
  'portal-tms-completed-rescues',
] as const;
